...
\noindent\fbox{
	\parbox{\textwidth}{
		\begin{itemize}
			...
			\item Even under `ideal' conditions (no frictions), there is intrinsic estimation bias across all study designs of different magnitudes.
...
When first-generation COVID-19 vaccines were rolled out via mass vaccination programmes in early 2021, the World Health Organisation (WHO) issued an interim guidance on evaluating vaccine effectiveness (VE), based primarily on past non-COVID-19 outbreaks, particularly influenza \citep{world2021evaluation}. Reflecting this, the WHO made an explicit preference for test-negative design (TND) or test-negative case-control (TNCC) in minimising confounding from selection in health-seeking behaviour, while acknowledging the merits of retrospective and prospective cohorts. Other methods, including the screening method, and regression discontinuity design (RDD), were also discussed \citep{orenstein1985field, world2021evaluation}. This recommendation, and their ubiquitous application in the COVID-19 VE literature, provides a basis for variations of cohorts and TNDs to be considered in this study.
...
\bibliography{2022-06_VEMethod_Article_Bibliography}
