...
telegram_send.send(conf='EcMetrics_Config_GeneralFlow.conf',
                   messages=['0_VEMethod_Sim1b_Parallel_CloudVersion_NoCI\n\n' +
...
VE_consol_all.to_parquet('VEMethod_Sim1b_Parallel_CloudVersion_NoCI.parquet', compression='brotli', index=False)
with open('VEMethod_Sim1b_Parallel_CloudVersion_NoCI.parquet', 'rb') as f:
    telegram_send.send(conf='EcMetrics_Config_GeneralFlow.conf',
                       files=[f],
                       captions=['VEMethod_Sim1b_Parallel_CloudVersion_NoCI'])

### End
telegram_send.send(conf='EcMetrics_Config_GeneralFlow.conf',
                   messages=['0_VEMethod_Sim1b_Parallel_CloudVersion_NoCI: COMPLETED'])
